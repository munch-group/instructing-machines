...
Begin by downloading the project. In the VS Code terminal, ask for it by name:
...
{{< project-download label="Download translationproject" type="light" >}}
:::

Either way you get a folder called `translationproject`.

The file `translationproject.py` in it is for your code. The file `test_translationproject.py` is the script you use to test the functions you write for this project (see @sec-testing).
