...
{{< downloadthis ../../project-files/translationproject/translationproject.py dname="translationproject" label="translationproject.py" type="light" >}} {{< downloadthis ../../project-files/translationproject/test_translationproject.py dname="test_translationproject" label="test_translationproject.py" type="light" >}}
:::
...
The file `translationproject.py` is for your code. The file `test_translationproject.py` is the script you use to test the functions you write for this project (see @sec-testing).
