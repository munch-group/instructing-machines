...
{{< project-download label="Download seqdistproject" type="light" >}}
:::

Either way you get a folder called `seqdistproject` with these files in it:

- `seqdistproject.py` is an empty file where you must write your code.
- `test_seqdistproject.py` is the test program that lets you test the code you write in `seqdistproject.py`.
