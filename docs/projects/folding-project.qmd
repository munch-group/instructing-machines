...
# Project: Primer analysis {#sec-folding-project}
...
That puts the `foldingproject` project folder straight into the `projects` folder inside your course folder, beside your notebooks.
...
You write your code in the file called `foldingproject.py`. In the terminal, navigate to the project folder and run your code in the usual way:

```txt
python foldingproject.py
```

To test the functions as you complete each one, you use `pytest` to run the project test suite in `test_foldingproject.py` using this command:

```txt
pytest test_foldingproject.py
```
