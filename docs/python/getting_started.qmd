...
4. Now close that terminal *completely* and open a new one. 


5. Run this in the new terminal to make sure pixi is installed. If it is, it will print its version nr.
...
7. To to the "getting started" page and download the course folder again
8. Open the Downloads folder and double-click instructing-machines.zip to unpack it.

9. In the terminal, run this to move it to your user folder
...
13. Then open `C:\im\instructing-machines` in VS Code using `File → Open Folder`.
