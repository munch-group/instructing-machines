...
```txt
pixi --quiet run -m ~/instructing-machines check
```
...
From now on all you need is to open the `C:\instructing-machines` folder using `File → Open Folder`. Remember, the entire course setup *only* works if you open the *folder*.
