...
::: column-page
| Wk | Double 1 | Double 2 | Single | Exercises |
|------------|---------------|------------|------------|---------------------|
| 1 | @sec-hello-world, @sec-values-operators-logic, @sec-precedence-steps | @sec-insides, @sec-instruction; @sec-meet-ai | @sec-machine-insides, @sec-course_tools | install & setup — @sec-getting_started |
|  |  |  |  |  |
| 2 | @sec-if-else, @sec-functions | @sec-predict-then-prove | @sec-functions | @sec-hello-world, @sec-values-operators-logic, @sec-precedence-steps, @sec-course_tools |
|  |  |  |  |  |
| 3 | @sec-objects, @sec-lists | @sec-explain-then-confirm | @sec-dictionaries, @sec-tuples | @sec-if-else, @sec-functions |
|  |  |  |  |  |
| 4 | @sec-iteration | @sec-practical-ai-use | @sec-files | (lab-split) @sec-objects, @sec-lists, @sec-dictionaries, @sec-tuples |
|  |  |  |  |  |
| 5 | @sec-data_structures, @sec-aliasing | @sec-how-models-produce-code | @sec-recursion, @sec-testing | (repeated) — @sec-iteration, @sec-files |
|  |  |  |  |  |
| 6 | @sec-translation-project, project workflow & the check widget | @sec-tests-are-the-contract | @sec-worked-example-composition | @sec-data_structures, @sec-recursion, @sec-testing |
|  |  |  |  |  |
| 7 | @sec-classes, @sec-folding-project | @sec-reading-and-judging | @sec-debugging-clinic | @sec-translation-project |
|  |  |  |  |  |
| 8 | @sec-alignment-project | @sec-plan-before-you-prompt | @sec-decomposition-clinic | @sec-folding-project, @sec-classes |
|  |  |  |  |  |
| 9 | @sec-codonbias-project, @sec-modules | @sec-the-docs-are-the-test | @sec-documentation-and-resources | @sec-alignment-project |
|  |  |  |  |  |
| 10 | @sec-hiv-project, @sec-directing-a-resource-clinic | @sec-delegating-a-whole-job | @sec-directing-a-resource-clinic | @sec-codonbias-project |
|  |  |  |  |  |
| 11 | @sec-seqdist-project | @sec-let-it-draft | @sec-debugging-clinic | @sec-hiv-project |
|  |  |  |  |  |
| 12 | @sec-orf-project | @sec-ask-for-another-way | @sec-dataframes | @sec-seqdist-project |
|  |  |  |  |  |
| 13 | @sec-assembly-project | @sec-learning-with-an-ai | @sec-debugging-clinic | @sec-orf-project |
|  |  |  |  |  |
