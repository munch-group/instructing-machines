...
#### Exercise 3 `AI: Drafter`
`most_common_base(dna)`: the single most frequent base in a DNA string. Worked example: `most_common_base('GGGATC') == 'G'`. Nasty case to consider: a genuine tie between two bases — decide, in writing, before you draft, what you want to happen, since last term's cohort found the assistant will pick silently and inconsistently if you do not.
