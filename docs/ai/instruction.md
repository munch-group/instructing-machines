...
![Every step up the ladder trades direct control for closeness to human language. Each layer is a *translator* down to the one below it — and the AI is the newest, and strangest, rung.](./images/fig-instruction-ladder.svg){#fig-instruction-ladder}
...
## Compilers and interpreters: two kinds of faithful translator {#sec-compile-interpret}
