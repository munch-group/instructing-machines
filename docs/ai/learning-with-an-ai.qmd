...
Now close the assistant. Tomorrow, with nothing open in front of you, write the same explanation out again from memory in your own words, and only then compare it with what you wrote yesterday. The second version is the one that counts, and the gap between the two is the honest measure of whether you learned the thing or merely watched it being explained well. Keep both versions. In @sec-the-ai-off-test you will do exactly this under exam conditions, and it will go a great deal better if this is not the first time you have tried it.
