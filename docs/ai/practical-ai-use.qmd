...
Ask the assistant the same underspecified question two different ways: first as something genuinely vague, such as "write me something to look at a DNA sequence," and then as a precise request naming the input, the output, and one edge case you care about. Compare the two replies. Which one would you have had to guess at least, and which one can you actually check against what you asked for?
