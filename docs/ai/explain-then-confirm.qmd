...
#### Exercise 1 [[ai: explainer]{.smallcaps}](../intro/course-introduction.qmd#sec-badge-explainer)
```python
def gc_content(dna:
    return dna.count('G') / len(dna)
```

#### Exercise 2 [[ai: explainer]{.smallcaps}](../intro/course-introduction.qmd#sec-badge-explainer)
```python
sequences = ['ATG', 'GCC', 'TAA'
print(sequences)
```

#### Exercise 3 [[ai: explainer]{.smallcaps}](../intro/course-introduction.qmd#sec-badge-explainer)
```python
for base in 'ATGC':
print(base)
```

#### Exercise 4 [[ai: explainer]{.smallcaps}](../intro/course-introduction.qmd#sec-badge-explainer)
```python
name = 'Preben'
print('Hello, ' name)
```
...
#### Exercise 5 [[ai: explainer]{.smallcaps}](../intro/course-introduction.qmd#sec-badge-explainer)
```python
counts = {'A': 4, 'T': 3, 'G': 2}
print(counts['C'])
```

#### Exercise 6 [[ai: explainer]{.smallcaps}](../intro/course-introduction.qmd#sec-badge-explainer)
```python
bases = ['A', 'T', 'G', 'C']
print(bases[4])
```

#### Exercise 7 [[ai: explainer]{.smallcaps}](../intro/course-introduction.qmd#sec-badge-explainer)
```python
...
#### Exercise 8 [[ai: explainer]{.smallcaps}](../intro/course-introduction.qmd#sec-badge-explainer)
```python
...
#### Exercise 9 [[ai: explainer]{.smallcaps}](../intro/course-introduction.qmd#sec-badge-explainer)
```python
dna = 'ATGGCCTAA'
print(dna[::-1])
```

#### Exercise 10 [[ai: explainer]{.smallcaps}](../intro/course-introduction.qmd#sec-badge-explainer)
```python
counts = {}
for base in 'ATGGCCA':
...
#### Exercise 11 [[ai: explainer]{.smallcaps}](../intro/course-introduction.qmd#sec-badge-explainer)
```python
...
#### Exercise 12 [[ai: explainer]{.smallcaps}](../intro/course-introduction.qmd#sec-badge-explainer)
```python
def add_base(bases=[]):
    bases.append('A')
    return bases
...
#### Exercise 13 [[ai: explainer]{.smallcaps}](../intro/course-introduction.qmd#sec-badge-explainer)
```python
original = ['A', 'T', 'G']
copy = original
copy.append('C')
...
#### Exercise 14 [[solo]{.smallcaps}](../intro/course-introduction.qmd#sec-badge-solo)
...
#### Exercise 15 [[ai: explainer]{.smallcaps}](../intro/course-introduction.qmd#sec-badge-explainer)
